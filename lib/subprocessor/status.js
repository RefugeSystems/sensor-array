...
module.exports.connection = function(details) {
	 ...
	 * 
	 * Specifically, this name should correspond to Resources in a related Synthesis
	 * Concept if one is associated with the SensorArray instance.
	 * 
	 ...
	 * 
	 * Specifically, these names should correspond to Resources in a related Synthesis
	 * Concept if one is associated with the SensorArray instance.
	 * 
	 * @property usage
	 * @type Array | String
